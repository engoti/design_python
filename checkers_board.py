...
# Named Constants(Does not Change)
ANIMATION_SPEED = 0
SCREEN_WIDTH = 500
...
# are the coordinates of the vertex lower-left corner. The width
...
#Calling the main Function to call the appearance of the board
def main():
